...
public partial class InputContext {
    ...
    public Input input { get { return inputEntity.input; } }
    public bool hasInput { get { return inputEntity != null; } }

    public InputEntity SetInput(Servises.IInputService newValue) {
        if (hasInput) {
            throw new Entitas.EntitasException("Could not set Input!\n" + this + " already has an entity with Input!",
    ...
    public void ReplaceInput(Servises.IInputService newValue) {
...
public partial class InputEntity {
    ...
    public Input input { get { return (Input)GetComponent(InputComponentsLookup.Input); } }
    public bool hasInput { get { return HasComponent(InputComponentsLookup.Input); } }

    public void AddInput(Servises.IInputService newValue) {
        var index = InputComponentsLookup.Input;
        var component = (Input)CreateComponent(index, typeof(Input));
