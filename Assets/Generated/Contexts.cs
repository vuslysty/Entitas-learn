...
public partial class Contexts {
    ...
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.PrimaryEntityIndex<GameEntity, float>(
            Id,
...
public static class ContextsExtensions {
    ...
    public static GameEntity GetEntityWithId(this GameContext context, float value) {
        return ((Entitas.PrimaryEntityIndex<GameEntity, float>)context.GetEntityIndex(Contexts.Id)).GetEntity(value);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
