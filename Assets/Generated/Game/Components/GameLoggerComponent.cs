...
public partial class GameContext {
    ...
    public Logger logger { get { return loggerEntity.logger; } }
    public bool hasLogger { get { return loggerEntity != null; } }

    public GameEntity SetLogger(ILogService newValue) {
        if (hasLogger) {
            throw new Entitas.EntitasException("Could not set Logger!\n" + this + " already has an entity with Logger!",
    ...
    public void ReplaceLogger(ILogService newValue) {
...
public partial class GameEntity {
    ...
    public Logger logger { get { return (Logger)GetComponent(GameComponentsLookup.Logger); } }
    public bool hasLogger { get { return HasComponent(GameComponentsLookup.Logger); } }

    public void AddLogger(ILogService newValue) {
        var index = GameComponentsLookup.Logger;
        var component = (Logger)CreateComponent(index, typeof(Logger));
